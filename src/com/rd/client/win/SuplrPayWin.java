...
public class SuplrPayWin extends Window{
	 ...
	 */
	public SuplrPayWin(DynamicForm form,String top,String left){
		this.form = form;
		this.top = top;
		this.left = left;
	}
	...
	public Window getViewPanel() {
		...
		//树形结构
		ds = SupplierListDS.getInstall("BAS_SUPPLIER", "BAS_SUPPLIER");
        ...
        addrList.addRecordDoubleClickHandler(new RecordDoubleClickHandler() {
			...
			public void onRecordDoubleClick(RecordDoubleClickEvent event) {
				...
				form.setValue("SUPLR_NAME", record.getAttribute("SUPLR_CNAME"));

 ...
 *
 */
public class SaveFormAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{
	...
	public SaveFormAction(ListGrid p_table, DynamicForm p_form, HashMap<String, String> p_map, Map<String, String > p_corr) {
		table = p_table;
		form = p_form;
		map = p_map;        //系统校验的MAP
	...
	public SaveFormAction(ListGrid p_table, DynamicForm p_form, HashMap<String, String> p_map, SGForm view) {
		table = p_table;
		form = p_form;
		map = p_map;        //系统校验的MAP
//		id_name = p_corr;   //ID和NAME的对应关系，适用于有ID和NAME对应关系，前台显示NAME值的文本
	...
	public SaveFormAction(ListGrid p_table, DynamicForm p_form, HashMap<String, String> p_map, SGForm view,Map<String,String> comb_val) {
		table = p_table;
		form = p_form;
		map = p_map;        //系统校验的MAP
//		id_name = p_corr;   //ID和NAME的对应关系，适用于有ID和NAME对应关系，前台显示NAME值的文本

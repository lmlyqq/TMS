...
public class SaveAction implements ClickHandler {
	...
	public SaveAction(SGTable p_table) {
		table = p_table;
	}
	public SaveAction(SGTable p_table, HashMap<String, String> p_map) {
		table = p_table;
		check_map = p_map;
	}
	
	public SaveAction(SGTable p_table, HashMap<String, String> p_map,SGForm view) {
		table = p_table;
		check_map = p_map;
		this.view = view;
	}
	public SaveAction(SGTable p_table, HashMap<String, String> p_map,SGForm view,int initBtn) {
		table = p_table;
		check_map = p_map;
		this.view = view;
		this.initBtn = initBtn;
	}
	public SaveAction(SGTable p_table, SGTable p_maintable,HashMap<String, String> p_map) {
		table = p_table;
		main_table = p_maintable;
		check_map = p_map;
	}
	
	public SaveAction(SGTable p_table, SGTable p_maintable,HashMap<String, String> p_map,SGForm view,int initBtn) {
		table = p_table;
		main_table = p_maintable;
		check_map = p_map;
		this.view  = view;
	...
	public SaveAction(SGTable p_table, SGTable p_maintable,HashMap<String, String> p_map,SGForm view) {
		table = p_table;
		main_table = p_maintable;
		check_map = p_map;
		this.view = view;

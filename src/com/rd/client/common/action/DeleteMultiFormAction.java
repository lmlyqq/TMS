...
public class DeleteMultiFormAction implements ClickHandler {

	private ValuesManager form;
	private ListGrid table;
	private ListGridRecord[] records;
	private HashMap<String, String> map;
	public DeleteMultiFormAction(ListGrid p_table, ValuesManager p_form) {
		table = p_table;
		form = p_form;
		this.map = null;
	}
	
	public DeleteMultiFormAction(ListGrid p_table, ValuesManager p_form,HashMap<String, String> map) {
		table = p_table;
		form = p_form;
		this.map = map;
	}

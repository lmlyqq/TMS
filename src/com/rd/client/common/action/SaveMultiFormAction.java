 ...
 *
 */
public class SaveMultiFormAction implements ClickHandler {
	...
	private SGForm view;
	public SaveMultiFormAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, Map<String, String > p_corr) {
		table = p_table;
		form = p_form;  
		map = p_map;
		id_name = p_corr;
	}
	public SaveMultiFormAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map) {
		table = p_table;
		form = p_form;  
		map = p_map;
	}
	
	public SaveMultiFormAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, SGForm view) {
		table = p_table;
		form = p_form;  
		map = p_map;
//		id_name = p_corr;

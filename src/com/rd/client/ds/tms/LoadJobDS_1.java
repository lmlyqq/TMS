 ...
 *
 */
public class LoadJobDS_1 extends DataSource{
	private static LoadJobDS_1 instance = null;

	public static LoadJobDS_1 getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new LoadJobDS_1(id, tableName);
		}
		return instance;
	}

	public static LoadJobDS_1 getInstance(String id) {
		if (instance == null) {
			instance = new LoadJobDS_1(id, id);
		}
		return instance;
	}

	public LoadJobDS_1(String id, String tableName) {

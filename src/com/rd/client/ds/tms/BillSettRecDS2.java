...
public class BillSettRecDS2 extends DataSource{

	private static BillSettRecDS instance = null;

	public static BillSettRecDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillSettRecDS(id, tableName);
		}
		return instance;
	}

	public static BillSettRecDS getInstance(String id) {
		if (instance == null) {
			instance = new BillSettRecDS(id, id);
		}
		return instance;
	}

	public BillSettRecDS2(String id, String tableName) {

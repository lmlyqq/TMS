...
public class SuplrFeeDS extends DataSource {

	private static SuplrFeeDS instance = null;

	public static SuplrFeeDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new SuplrFeeDS(id, tableName);
		}
		return instance;
	}

	public static SuplrFeeDS getInstance(String id) {
		if (instance == null) {
			instance = new SuplrFeeDS(id, id);
		}
		return instance;
	}

	public SuplrFeeDS(String id, String tableName) {

 ...
 *
 */
public class LoadJobDS_2 extends DataSource{
	private static LoadJobDS_2 instance = null;

	public static LoadJobDS_2 getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new LoadJobDS_2(id, tableName);
		}
		return instance;
	}

	public static LoadJobDS_2 getInstance(String id) {
		if (instance == null) {
			instance = new LoadJobDS_2(id, id);
		}
		return instance;
	}

	public LoadJobDS_2(String id, String tableName) {
...
//		DataSourceTextField SHPM_NO = new DataSourceTextField("SUPLR_NAME", Util.TI18N.SUPLR_NAME(),140);//调度单号

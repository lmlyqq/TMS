 ...
 *
 */
public class ChangeRecordDS extends DataSource{
	private static ChangeRecordDS instance = null;

	public static ChangeRecordDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ChangeRecordDS(id, tableName);
		}
		return instance;
	}

	public static ChangeRecordDS getInstance(String id) {
		if (instance == null) {
			instance = new ChangeRecordDS(id, id);
		}
		return instance;
	}

	public ChangeRecordDS(String id, String tableName) {

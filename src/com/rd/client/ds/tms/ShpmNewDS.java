 ...
 *
 */
public class ShpmNewDS extends DataSource{
	private static ShpmNewDS instance = null;

	public static ShpmNewDS getInstance(String id, String tableName) {
		//if (instance == null) {
			instance = new ShpmNewDS(id, tableName);
		//}
		return instance;
	}

	public static ShpmNewDS getInstance(String id) {
		if (instance == null) {
			instance = new ShpmNewDS(id, id);
		}
		return instance;
	}

	public ShpmNewDS(String id, String tableName) {

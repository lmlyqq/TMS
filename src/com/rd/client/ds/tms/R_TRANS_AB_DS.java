 ...
 *
 */
public class R_TRANS_AB_DS extends DataSource{
	private static R_TRANS_AB_DS instance = null;

	public static R_TRANS_AB_DS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new R_TRANS_AB_DS(id, tableName);
		}
		return instance;
	}

	public static R_TRANS_AB_DS getInstance(String id) {
		if (instance == null) {
			instance = new R_TRANS_AB_DS(id, id);
		}
		return instance;
	}

	public R_TRANS_AB_DS(String id, String tableName) {

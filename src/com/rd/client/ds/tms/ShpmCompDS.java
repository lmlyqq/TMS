 ...
 *
 */
public class ShpmCompDS extends DataSource{
	private static ShpmCompDS instance = null;

	public static ShpmCompDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ShpmCompDS(id, tableName);
		}
		return instance;
	}

	public static ShpmCompDS getInstance(String id) {
		if (instance == null) {
			instance = new ShpmCompDS(id, id);
		}
		return instance;
	}

	public ShpmCompDS(String id, String tableName) {

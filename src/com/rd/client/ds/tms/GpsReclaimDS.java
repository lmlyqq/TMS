 ...
 *
 */
public class GpsReclaimDS extends DataSource{
	private static GpsReclaimDS instance = null;

	public static GpsReclaimDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new GpsReclaimDS(id, tableName);
		}
		return instance;
	}

	public static GpsReclaimDS getInstance(String id) {
		if (instance == null) {
			instance = new GpsReclaimDS(id, id);
		}
		return instance;
	}

	public GpsReclaimDS(String id, String tableName) {

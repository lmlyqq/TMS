 ...
 *
 */
public class BillSettGroupDS extends DataSource{

	private static BillSettGroupDS instance = null;

	public static BillSettGroupDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillSettGroupDS(id, tableName);
		}
		return instance;
	}

	public static BillSettGroupDS getInstance(String id) {
		if (instance == null) {
			instance = new BillSettGroupDS(id, id);
		}
		return instance;
	}

	public BillSettGroupDS(String id, String tableName) {

 ...
 *
 */
public class LoadDS extends DataSource{
	private static LoadDS instance = null;

	public static LoadDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new LoadDS(id, tableName);
		}
		return instance;
	}

	public static LoadDS getInstance(String id) {
		if (instance == null) {
			instance = new LoadDS(id, id);
		}
		return instance;
	}

	public LoadDS(String id, String tableName) {

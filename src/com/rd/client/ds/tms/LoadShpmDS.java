 ...
 *
 */
public class LoadShpmDS extends DataSource{
	private static LoadShpmDS instance = null;

	public static LoadShpmDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new LoadShpmDS(id, tableName);
		}
		return instance;
	}

	public static LoadShpmDS getInstance(String id) {
		if (instance == null) {
			instance = new LoadShpmDS(id, id);
		}
		return instance;
	}

	public LoadShpmDS(String id, String tableName) {

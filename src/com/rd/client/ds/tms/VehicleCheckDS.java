...
public class VehicleCheckDS extends DataSource {
	
	private static VehicleCheckDS instance = null;

	public static VehicleCheckDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new VehicleCheckDS(id, tableName);
		}
		return instance;
	}

	public static VehicleCheckDS getInstance(String id) {
		if (instance == null) {
			instance = new VehicleCheckDS(id, id);
		}
		return instance;
	}

	public VehicleCheckDS(String id, String tableName) {

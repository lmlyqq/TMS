 ...
 *
 */
public class OrgCustomerDS extends DataSource {
	
	private static OrgCustomerDS instance = null;

    public static OrgCustomerDS getInstance(String id) {
        if (instance == null) {
            instance = new OrgCustomerDS(id, id);
        }
        return instance;
    }
    
    public static OrgCustomerDS getInstance(String id, String tableName) {
        if (instance == null) {
            instance = new OrgCustomerDS(id, tableName);
        }
        return instance;
    }
    public OrgCustomerDS(String id, String tableName) {

...
public class AreaDS extends DataSource{
	 private static AreaDS instance = null;

	    public static AreaDS getInstance(String tableName) {
	        if (instance == null) {
	            instance = new AreaDS(tableName);
	        }
	        return instance;
	    }
	    public AreaDS(String tableName) {
	    	setID(tableName);

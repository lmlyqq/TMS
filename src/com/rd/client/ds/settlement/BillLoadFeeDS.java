 ...
 *
 */
public class BillLoadFeeDS extends DataSource{
	private static BillLoadFeeDS instance = null;

	public static BillLoadFeeDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillLoadFeeDS(id, tableName);
		}
		return instance;
	}

	public static BillLoadFeeDS getInstance(String id) {
		if (instance == null) {
			instance = new BillLoadFeeDS(id, id);
		}
		return instance;
	}

	public BillLoadFeeDS(String id, String tableName) {

 ...
 *
 */
public class NewTariffStandAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{

	private DynamicForm form;
	private Map<String, String> initMap;
	private StandardRateView view;

	public NewTariffStandAction(DynamicForm p_form, Map<String, String> map,StandardRateView view) {
		form = p_form;
		initMap = map;
		this.view = view;
	}

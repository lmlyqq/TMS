 ...
 *
 */
public class NewSuplrTariffAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{

	private DynamicForm form;
	private Map<String, String> initMap;
	private SuplrRateManagerView view;

	public NewSuplrTariffAction(DynamicForm p_form, Map<String, String> map,SuplrRateManagerView view) {
		form = p_form;
		initMap = map;
		this.view = view;
	}

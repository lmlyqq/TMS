 ...
 *
 */
public class NewTariffCondStandAction extends NewAction{
	...
	public NewTariffCondStandAction(SGTable pTable,HashMap<String, String> initMap,StandardRateView view) {
		super(pTable);
		this.view  = view;
	}
	
	public NewTariffCondStandAction(SGTable pTable,HashMap<String, String> initMap,PoleManagerView view,boolean isTff) {
		super(pTable);
		this.poleView  = view;
		this.isTff = isTff;
	}

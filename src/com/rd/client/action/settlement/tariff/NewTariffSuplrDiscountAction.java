 ...
 *
 */
public class NewTariffSuplrDiscountAction extends NewAction{
	...
	public NewTariffSuplrDiscountAction(SGTable pTable,HashMap<String, String> initMap,SuplrRateManagerView view) {
		//this.table=pTable;
		super(pTable);
		this.view  = view;
	}

 ...
 *
 */
public class NewSuplrTariffRuleAction extends NewFormAction{
	private SuplrRateManagerView view;
	public NewSuplrTariffRuleAction(ValuesManager pForm, Map<String, String> map,SuplrRateManagerView view) {
		super(pForm, map);
		this.view = view;
	}

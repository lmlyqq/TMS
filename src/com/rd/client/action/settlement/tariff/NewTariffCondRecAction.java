 ...
 *
 */
public class NewTariffCondRecAction extends NewAction{
	
	private RateManagerRecView view;
	
	public NewTariffCondRecAction(SGTable pTable,HashMap<String, String> initMap,RateManagerRecView view) {
		super(pTable);
		this.view  = view;
	}

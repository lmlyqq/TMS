...
public class saveTaffRulAction implements ClickHandler{
	...
	public saveTaffRulAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, RateManagerView view) {
		this.view = view;
		table = p_table;
		form = p_form;  
		map = p_map;
	...
	public saveTaffRulAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, RateManagerRecView view) {
		this.rview = view;
		table = p_table;
		form = p_form;  
		map = p_map;
	...
	public saveTaffRulAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, PoleManagerView view) {
		this.pview = view;
		table = p_table;
		form = p_form;  
		map = p_map;

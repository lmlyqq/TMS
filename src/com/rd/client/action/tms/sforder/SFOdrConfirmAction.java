 ...
 *
 */
public class SFOdrConfirmAction implements ClickHandler,com.smartgwt.client.widgets.events.ClickHandler{
...
//	private ValuesManager vm;
	...
	public SFOdrConfirmAction(ListGrid table,ValuesManager vm,SFOrderView view){
		this.table = table;
//		this.vm = vm;
		this.view = view;
	}
	...
	private void doSome() {
		...
		//存储过程名称
		String proName="SP_SFORDER_CONFIRM(?,?,?)"; //odr_no,user_id,output_result

...
public class SelfConPayoutWin extends Window{
...
//	private boolean payout;
	 ...
	 */
	public SelfConPayoutWin(ListGrid table,boolean payout,TmsSelfControl view){
		this.table = table;
		this.view = view;
	}
	
	public SelfConPayoutWin(){

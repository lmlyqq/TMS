 ...
 *
 */
public class VehicleCancelReportAction implements ClickHandler,com.smartgwt.client.widgets.events.ClickHandler{
	...
	public VehicleCancelReportAction(ListGrid table,VehicleReportView view){
		this.table = table;
		this.view = view;
	}
	...
	private void doSome() {
		...
		if(msg.toString().length() > 0){
			SC.warn("车辆【"+msg.substring(0,msg.length()-1) +"】未上报！");
			return;
		}

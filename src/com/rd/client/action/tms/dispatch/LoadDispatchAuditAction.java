 ...
 *
 */
public class LoadDispatchAuditAction implements com.smartgwt.client.widgets.menu.events.ClickHandler {
...
//	private ListGridRecord[] records;
	...
	public LoadDispatchAuditAction(SGTable p_loadTable) {
		this.loadTable = p_loadTable;
	}
	
	public LoadDispatchAuditAction(SGTable p_loadTable, HashMap<String, String> p_map, DispatchView p_view) {

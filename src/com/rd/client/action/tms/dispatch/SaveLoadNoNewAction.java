 ...
 *
 */
public class SaveLoadNoNewAction implements ClickHandler {
	...
	private int pos;
	public SaveLoadNoNewAction(SGTable p_loadTable, HashMap<String, String> p_map, VehicleDispatchView p_view) {

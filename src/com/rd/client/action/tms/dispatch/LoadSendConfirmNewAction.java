 ...
 *
 */
public class LoadSendConfirmNewAction implements ClickHandler {

	private VehicleDispatchView view;
	private SGTable loadTable;
	private SGTable shpmTable;
	private ListGridRecord lstrecord;
	public LoadSendConfirmNewAction(VehicleDispatchView p_view, SGTable p_loadTable, SGTable p_shpmTable) {
		this.view = p_view;

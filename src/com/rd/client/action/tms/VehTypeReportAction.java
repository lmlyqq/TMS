 ...
 *
 */
public class VehTypeReportAction implements ClickHandler,com.smartgwt.client.widgets.events.ClickHandler{
	...
	public VehTypeReportAction(ListGrid table,VehicleReportView view){
		this.table = table;
		this.view = view;
	}
	...
	private void doSome() {
		...
		if(msg.toString().length() > 0){
			SC.warn("车型【"+msg.substring(0,msg.length()-1) +"】已上报！");
			return;
		}

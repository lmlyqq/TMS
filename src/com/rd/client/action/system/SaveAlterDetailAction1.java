 ...
 *
 */
public class SaveAlterDetailAction1 implements ClickHandler {
	...
	public SaveAlterDetailAction1(SGTable p_table) {
		table = p_table;
	}
	public SaveAlterDetailAction1(SGTable p_table, HashMap<String, String> p_map) {
		table = p_table;
		check_map = p_map;
	}
	
	public SaveAlterDetailAction1(SGTable p_table,SGTable m_table ,HashMap<String, String> p_map,AlterSettingView view) {
		table = p_table;

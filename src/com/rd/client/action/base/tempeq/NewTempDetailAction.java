...
public class NewTempDetailAction implements ClickHandler{
	...
	public NewTempDetailAction(ValuesManager form,ListGrid downTable,Map<String, String> initMap,BasTempEqView view,int initBtn){
		this.form = form;

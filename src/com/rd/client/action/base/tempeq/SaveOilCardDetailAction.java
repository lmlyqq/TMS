...
public class SaveOilCardDetailAction implements ClickHandler{
	...
	public SaveOilCardDetailAction(ListGrid p_table,ValuesManager p_form, HashMap<String, String> p_map,BasOilCardView view,int initBtn) {
		this.table = p_table;
		this.form = p_form;  
		this.map = p_map;
		this.view = view;
	...
	public void doInsert(Map map) {
		...
		for(int i=0;i<records.length;i++){
			sf = new StringBuffer();
			sf.append("insert into BAS_OILCARD_RECHARGE(ID,RECHAGE_TIME,RECHARGER,RECHARGE_AMOUNT,PRE_AMOUNT,OILCARD");
			sf.append(",ADDTIME,ADDWHO)");
			sf.append(" values(");
			sf.append("sys_guid(),");
//			sf.append("'"+records[i].getAttribute("PRE_AMOUNT")+"',");
			sf.append("to_date('"+form.getItem("RECHAGE_TIME").getValue()+"','YYYY-MM-DD HH24:MI:SS'),");
			sf.append("'"+form.getItem("RECHARGER").getValue()+"',");
			sf.append("'"+form.getItem("RECHARGE_AMOUNT").getValue()+"',");
			sf.append("'"+form.getItem("PRE_AMOUNT").getValue()+"',");
			sf.append("'"+records[i].getAttribute("OILCARD")+"',");
...
//			sf = new StringBuffer();
//			sf.append("update BAS_OILCARD set STATUS='DF252F0637784E9EA575CCACB64050FC',");
//			sf.append(" LOAD_NO='',PLATE_NO='' ");
//			sf.append("where OILCARD='"+records[j].getAttribute("OILCARD")+"'");
//			sqlList1.add(sf.toString());
//		}
...
//					records[i].setAttribute("OILCARD", "");
...
//				findValues.addCriteria("OILCARD", view.gpsTable.getSelectedRecord().getAttribute("OILCARD").toString());
...
//					sf.append("update BAS_OILCARD set STATUS='DF252F0637784E9EA575CCACB64050FC',");
////					sf.append(" LOAD_NO='',PLATE_NO='' ");
//					sf.append("where OILCARD='"+view.gpsTable.getSelectedRecord().getAttribute("OILCARD")+"'");
//					sql.add(sf.toString());
//					Util.async.excuteSQLList(sql, new AsyncCallback<String>() {
//						
//						@Override
//						public void onSuccess(String result) {
//							MSGUtil.showOperSuccess();
...
//							view.gpsTable.getSelectedRecord().setAttribute("OILCARD", "");
//							view.gpsTable.redraw();
//							if(view != null){
//								view.initSaveBtn();
//							}
...
//					ArrayList<String> sqlList1 = new ArrayList<String>();
//					StringBuffer sf = new StringBuffer();
//					sf.append("update BAS_TEMPEQ set STATUS='DF252F0637784E9EA575CCACB64050FC',");
//					sf.append(" LOAD_NO='',PLATE_NO='' ");

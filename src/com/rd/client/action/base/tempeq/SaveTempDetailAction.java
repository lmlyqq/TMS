...
public class SaveTempDetailAction implements ClickHandler{
	...
	private BasTempEqView view;
	private int initBtn =0;
	
	public SaveTempDetailAction(ListGrid p_table,ValuesManager p_form, HashMap<String, String> p_map, BasTempEqView view,int initBtn) {
		this.table = p_table;
		this.form = p_form;  
		this.map = p_map;
		this.view = view;
	...
	public void doInsert(Map map) {
		...
		for(int i=0;i<records.length;i++){
			...
			sf.append("ABNORMAL_REASON,DUTY_TO,NOTES,ADDTIME,ADDWHO,EDITTIME,EDITWHO)");
			sf.append(" values(");
			sf.append("sys_guid(),");
			...
			if(ObjUtil.isNotNull(form.getItem("NOTES").getValue())){

...
import com.rd.client.action.settlement.DeleteSuplrRuleAction;
import com.rd.client.action.settlement.NewSuplrRuleActiom;
import com.rd.client.action.settlement.NewSuplrRuleDiscountAction;
...
//		CARRY_TYP.setTitle(ColorUtil.getRedTitle(Util.TI18N.CARRY_TYP()));
		...
		final SGCombo APPORT_BASE = new SGCombo("APPORT_BASE", ColorUtil.getRedTitle("分摊基准"));
...
//		EXPRESS_FL
		...
		basInfo2.setItems(FEE_ATTR,FEE_ID,FEE_BASE,CARRY_TYP,SUM_MODE,UOM_UNIT,WEIGHT_UNIT,VOLUME_UNIT,FEE_TYP,GRADE_BASE,APPORT_BASE,PRIORTY,
...
//		vm.addMember(basInfo);
	...
	public void createBtnWidget(ToolStrip strip) {
		...
		newB = createBtn(StaticRef.CREATE_BTN,SettPrivRef.SuplrRule_P0_01);
		newB.addClickHandler(new NewSuplrRuleActiom(vm, cache_map,this));
		
		savB = createBtn(StaticRef.SAVE_BTN,SettPrivRef.SuplrRule_P0_02);
		savB.addClickHandler(new SaveSuplrRuleAction(table,vm,check_map,this));
		
		delB = createBtn(StaticRef.DELETE_BTN,SettPrivRef.SuplrRule_P0_03);
		delB.addClickHandler(new DeleteSuplrRuleAction(table, vm));
		
		canB = createBtn(StaticRef.CANCEL_BTN,SettPrivRef.SuplrRule_P0_04);
		...
		copyButton = createBtn(StaticRef.COPY_BTN,SettPrivRef.SuplrRule_P0_09);
		...
		add_detail_map.put(SettPrivRef.SuplrRule_P0_01, newB);
		add_detail_map.put(SettPrivRef.SuplrRule_P0_09, copyButton);
		del_detail_map.put(SettPrivRef.SuplrRule_P0_03, delB);
		sav_detail_map.put(SettPrivRef.SuplrRule_P0_02, savB);
		sav_detail_map.put(SettPrivRef.SuplrRule_P0_04, canB);
	...
	private ToolStrip createDiscountBtn(){
		...
		newD = createBtn(StaticRef.CREATE_BTN,SettPrivRef.SuplrRule_P0_05);
		newD.addClickHandler(new NewSuplrRuleDiscountAction(discountTable, null, this));
		...
		savD = createBtn(StaticRef.SAVE_BTN,SettPrivRef.SuplrRule_P0_06);
		...
		delD = createBtn(StaticRef.DELETE_BTN,SettPrivRef.SuplrRule_P0_07);
		delD.addClickHandler(new DeleteAction(discountTable));
		
		canD = createBtn(StaticRef.CANCEL_BTN,SettPrivRef.SuplrRule_P0_08);
		...
		add_discount_map.put(SettPrivRef.SuplrRule_P0_05, newD);
		del_discount_map.put(SettPrivRef.SuplrRule_P0_07, delD);
		sav_discount_map.put(SettPrivRef.SuplrRule_P0_06, savD);
		sav_discount_map.put(SettPrivRef.SuplrRule_P0_08, canD);
	...
	public void initVerify() {
		...
		check_map.put("APPORT_BASE", StaticRef.CHK_NOTNULL + "分摊基准");
		...
		cache_map.put("FEE_ID", "4E57D62F321A47E085E3F22845F35945");

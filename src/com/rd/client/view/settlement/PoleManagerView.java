...
import com.rd.client.ds.settlement.PoleHeaderDS;
 ...
 * 费用结算--标杆设置
 * @author fanglm
 * @createTime 2012-06-29
 */
@ClassForNameAble
public class PoleManagerView extends SGForm implements PanelFactory {
	...
	/*public PoleManagerView(String id) {
		super(id);
	}*/
	...
	public Canvas getViewPanel() {
		...
		ds = PoleHeaderDS.getInstance("V_POLE_HEADER","TARIFF_HEADER");
...
//		layOut2.setVisible(false);
	...
	private SectionStack createMainInfo() {
		...
		SGText TFF_NAME=new SGText("TFF_NAME", "标杆名称");
...
//		CARRY_TYP.setTitle(ColorUtil.getRedTitle(Util.TI18N.CARRY_TYP()));
		...
		SGCombo GRADE_BASE = new SGCombo("GRADE_BASE", Util.TI18N.GRADE_BASE());
...
//		CONT_PRICE.setValue("0.00");
		...
		basInfo2.setItems(START_AREA_ID_NAME, END_AREA_ID_NAME, TRANS_SRVC_ID, FEE_ATTR,FEE_ID,FEE_BASE,
				CARRY_TYP,UOM_UNIT,WEIGHT_UNIT,VOLUME_UNIT,FEE_TYP,PRIORTY,GRADE_BASE,
	...
	private ToolStrip createFeeBtn(){
		...
		newB.addClickHandler(new NewTariffRuleAction(vm, fee_cache_map,getThis(),false));
...
//		map.put("FEE_TYP", "FEE_TYP_NAME");
	...
	private ToolStrip createConditionBtn(){
		...
		newC.addClickHandler(new NewTariffCondAction(groupTable, null, this,false));
...
//		detail_ck_map.put("CARRY_TYP", StaticRef.CHK_NOTNULL + Util.TI18N.CARRY_TYP());
	...
	public PoleManagerView getThis(){
		return this;
	}

	@Override
	public Canvas createCanvas(String id,TabSet tabSet) {
		PoleManagerView view = new PoleManagerView();
		view.setFUNCID(id);

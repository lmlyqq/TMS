...
public class DispLoadWin extends Window{
	...
	public DispLoadWin(DispatchView view,String load_no) {
		this.view = view;
		this.load_no=load_no;
		this.history_flag = "false";
	}
	
	public DispLoadWin(DispatchView view,String load_no,String h_flag) {
		this.view = view;
		this.load_no=load_no;

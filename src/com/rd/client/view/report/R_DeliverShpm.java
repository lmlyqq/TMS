...
import com.rd.client.ds.report.RDeliverds;
...
@ClassForNameAble
public class R_DeliverShpm extends SGForm implements PanelFactory{
	...
	/*public R_DeliverShpm(String id) {
		super(id);
	}*/
	...
	private DynamicForm createSearchForm(SGPanel form){
		...
		SLF_DELIVER_FLAG.setValue(true);
	...
	public Canvas getViewPanel() {
		...
		ds = RDeliverds.getInstance("R_DELIVER_SHPM","TRANS_SHIPMENT_HEADER");
		form = new SGPanel();
	...
	private void createList(){
		...
		ListGridField LOAD_NO = new ListGridField("LOAD_NO",Util.TI18N.LOAD_NO());
		...
		ListGridField SLF_DELIVER_FLAG = new ListGridField("SLF_DELIVER_FLAG",Util.TI18N.SLF_PICKUP_FLAG());
		...
		table.setFields(ODR_NO,REFENENCE1,SHPM_NO,LOAD_NO,CUSTOMER_NAME,BIZ_TYP_NAME,STATUS_NAME,LOAD_AREA_NAME2,LOAD_ADDRESS,UNLOAD_AREA_NAME2,
				UNLOAD_ADDRESS,UNLOAD_CONTACT,UNLOAD_TEL,DEPART_TIME,UNLOAD_TIME,POD_TIME,SLF_DELIVER_FLAG);
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		R_DeliverShpm view = new R_DeliverShpm();
		view.setFUNCID(id);

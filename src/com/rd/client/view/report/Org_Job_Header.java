...
import com.rd.client.ds.report.Org_Job_Header_DS;
 ...
 */
@ClassForNameAble
public class Org_Job_Header extends SGForm implements PanelFactory {
	...
	/*public Org_Job_Header(String id) {
		super(id);
...
//		Util.initCodesComboValue(R_ODR_TYP, "ORD_TYP");
		...
		form.setItems(ODR_TIME_FROM,ODR_TIME_TO,radioGroupItem,EXEC_ORG_ID,EXEC_ORG_ID_NAME,C_ORG_FLAG);
		return form;
	}
	...
	public Canvas getViewPanel() {
		...
		DS = Org_Job_Header_DS.getInstance("R_MNG_ORG_SUM");
	...
	private void createListFields(SGTable table){
		ListGridField CAR_ORG_ID = new ListGridField("EXEC_ORG_ID_NAME",Util.TI18N.EXEC_ORG_ID(),90);
...
//		Util.initFloatListField(COST, StaticRef.PRICE_FLOAT);
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		Org_Job_Header view = new Org_Job_Header();
		view.setFUNCID(id);

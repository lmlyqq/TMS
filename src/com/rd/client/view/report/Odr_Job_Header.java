...
import com.rd.client.ds.report.Odr_Job_Header_DS;
 ...
 */
@ClassForNameAble
public class Odr_Job_Header extends SGForm implements PanelFactory {
	...
	/*public Odr_Job_Header(String id) {
		super(id);
...
//		SGText CUSTOMER = new SGText("CUSTOMER_ID",Util.TI18N.CUSTOMER_ID_NAME(),true);
//		CUSTOMER.setColSpan(2);
//		CUSTOMER.setTitleOrientation(TitleOrientation.TOP);
...
//		TRANS_SRVC_ID.setWidth(127);
		...
		form.setItems(ODR_TIME_FROM,ODR_TIME_TO,radioGroupItem,BIZ_TYP,
	...
	public Canvas getViewPanel() {
		...
		DS = Odr_Job_Header_DS.getInstance("R_MNG_ODR_SUM");
	...
	private void createListFields(SGTable table){
		ListGridField R_BIZ_TYPE = new ListGridField("BIZ_TYP_NAME",Util.TI18N.BIZ_TYP(),90);
...
//		Util.initFloatListField(COST, StaticRef.PRICE_FLOAT);
		...
		table.setFields(R_BIZ_TYPE,UNLOAD_QNTY,UNLOAD_VOL,UNLOAD_NWGT);
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		Odr_Job_Header view = new Odr_Job_Header();
		view.setFUNCID(id);

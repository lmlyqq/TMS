...
import com.rd.client.ds.report.R_KPI_POD_RATE_DS;
 ...
 */
@ClassForNameAble
public class R_KPI_POD_RATE extends SGForm implements PanelFactory {
	...
	/*public R_KPI_POD_RATE(String id) {
		super(id);
	}*/
	...
	public Canvas getViewPanel() {
		...
		ds = R_KPI_POD_RATE_DS.getInstance("R_KPI_POD_RATE","R_KPI_POD_RATE");
	...
	private void createFields(SGTable table) {
		...
		ListGridField R_POD_RATE = new ListGridField("per",Util.TI18N.R_POD_RATE(),90);
		...
		table.setFields(EXEC_ORG_ID,EXEC_ORG_ID_NAME,SUPLR_NAME,ODR_QNTY,R_POD_RATE,R_1DAY,R_2DAY,R_3DAY,R_4DAY,R_5DAY,R_6DAY);
...
//      expButton.addClickHandler(new ExportAction(table, "addtime desc"));
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		R_KPI_POD_RATE view = new R_KPI_POD_RATE();
		view.setFUNCID(id);

...
import com.rd.client.ds.report.Area_Job_Header_DS;
 ...
 */
@ClassForNameAble
public class Area_Job_Header extends SGForm implements PanelFactory {
	...
	/*public Area_Job_Header(String id) {
		super(id);
	}*/
	...
	public Canvas getViewPanel() {
		...
		DS = Area_Job_Header_DS.getInstance("R_MNG_AREA_SUM");
...
//		ListGridField AREA_NAME = new ListGridField("AREA_CNAME",Util.TI18N.R_AREA_NAME(),77);
		ListGridField LOAD_AREA_NAME2=new ListGridField("LOAD_AREA_NAME2","发货城市",100);
		ListGridField UNLOAD_AREA_NAME2=new ListGridField("UNLOAD_AREA_NAME2","收获城市",100);
//		ListGridField PROVENCE = new ListGridField("PROVENCE",Util.TI18N.R_PROVENCE(),90);
//		ListGridField TRANS_UOM = new ListGridField("TRANS_UOM",Util.TI18N.ORD_PACK_ID(),70);
		ListGridField UNLOAD_QNTY = new ListGridField("LD_QNTY",Util.TI18N.R_LOAD_QNTY(),70);
//		ListGridField LOSDAM = new ListGridField("LOSS_QNTY",Util.TI18N.LOSDAM_FLAG(),70);
		ListGridField UNLOAD_VOL = new ListGridField("LD_VOL",Util.TI18N.R_UNLOAD_VOL(),70);
		ListGridField UNLOAD_NWGT = new ListGridField("LD_GWGT",Util.TI18N.R_NWGT(),70);
//		ListGridField COST = new ListGridField("PRE_FEE",Util.TI18N.R_COST(),70);
//		ListGridField PRECENT = new ListGridField("PER",Util.TI18N.R_PRCENT(),70);
...
//		Util.initFloatListField(COST, StaticRef.PRICE_FLOAT);
		...
		table.setFields(LOAD_AREA_NAME2,UNLOAD_AREA_NAME2,UNLOAD_QNTY,UNLOAD_VOL,UNLOAD_NWGT);
	...
	public DynamicForm createSerchForm(SGPanel form) {
		...
		form.setItems(ODR_TIME_FROM,ODR_TIME_TO,radioGroupItem,LOAD_AREA_ID2,LOAD_AREA_NAME2,UNLOAD_AREA_ID2,UNLOAD_AREA_NAME2,
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		Area_Job_Header view = new Area_Job_Header();
		view.setFUNCID(id);

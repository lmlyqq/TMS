...
import com.rd.client.ds.report.R_KPI_UNLOAD_RATE_DS;
 ...
 */
@ClassForNameAble
public class R_KPI_UNLOAD_RATE extends SGForm implements PanelFactory{
	...
	/*public R_KPI_UNLOAD_RATE(String id) {
		super(id);
	}*/
	...
	public Canvas getViewPanel() {
		...
		ds = R_KPI_UNLOAD_RATE_DS.getInstance("R_KPI_UNLOAD_RATE","R_KPI_UNLOAD_RATE");
	...
	private void createFields(SGTable table) {
		/**
		 * 供应商	订单数	准时到货率	1DAY	2DAYS	3DAYS	4DAYS	5DAYS	>5DAYS
		 */
		ListGridField SUPLR_NAME = new ListGridField("suplr_name",Util.TI18N.SUPLR_NAME(),120);
		ListGridField ODR_QNTY = new ListGridField("num","作业单票数",90);		
		ListGridField UNLOAD_RATE = new ListGridField("per",Util.TI18N.R_UNLOAD_RATE(),90);
		...
		table.setFields(EXEC_ORG_ID,EXEC_ORG_ID_NAME,SUPLR_NAME,ODR_QNTY,UNLOAD_RATE,R_1DAY,R_2DAY,R_3DAY,R_4DAY,R_5DAY,R_6DAY);
...
//        expButton.addClickHandler(new KPIExportAction(table,fieldname,"addtime desc"));
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		R_KPI_UNLOAD_RATE view = new R_KPI_UNLOAD_RATE();
		view.setFUNCID(id);

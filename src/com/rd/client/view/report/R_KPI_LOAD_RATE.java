...
import com.rd.client.ds.report.R_KPI_LOAD_RATE_DS;
...
@ClassForNameAble
public class R_KPI_LOAD_RATE extends SGForm implements PanelFactory {
	...
	/*public R_KPI_LOAD_RATE(String id) {
		super(id);
	}*/
	...
	public Canvas getViewPanel() {
		...
		DS = R_KPI_LOAD_RATE_DS.getInstance("R_KPI_LOAD_RATE","R_KPI_LOAD_RATE");
	...
	private void createListFields(SGTable table){
		...
		ListGridField R_ON_TIME = new ListGridField("PER",Util.TI18N.R_ON_TIME(),70);
		Util.initFloatListField(R_ON_TIME, StaticRef.FLOAT);
...
//        expButton.addClickHandler(new KPIExportAction(table,fieldname,"addtime desc"));
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		R_KPI_LOAD_RATE view = new R_KPI_LOAD_RATE();
		view.setFUNCID(id);

...
import com.rd.client.common.action.DeleteAction2;
import com.rd.client.common.action.NewAction2;
import com.rd.client.common.action.SaveAction2;
...
import com.rd.client.ds.base.SkuClsDS2;
 ...
 */
@ClassForNameAble
public class BasSkuClassView2 extends SGForm implements PanelFactory {
	...
	/*public BasSkuClassView2(String id) {
		super(id);
	}*/
	...
	public Canvas getViewPanel() {
		...
		ds = SkuClsDS2.getInstance("V_BAS_SKU_CLS","BAS_SKU_CLS");
	...
	private void createListFields(SGTable table){
		  ...
		  FACTOR.setType(ListGridFieldType.INTEGER);
		  ListGridField SHOW_SEQ = new ListGridField("SHOW_SEQ",Util.TI18N.SHOW_SEQ(),60);
		  SHOW_SEQ.setType(ListGridFieldType.INTEGER);
...
//		  CUSTOMER_ID.setFilterOnKeypress(true);
	...
	public void createBtnWidget(ToolStrip toolStrip) {
        ...
        newButton.addClickHandler(new NewAction2(table,cache_map,this));
        
        IButton saveButton = createBtn(StaticRef.SAVE_BTN,BasPrivRef.SKUCLS_P0_02);
        saveButton.addClickHandler(new SaveAction2(table,check_map,this));
        
        IButton delButton = createBtn(StaticRef.DELETE_BTN,BasPrivRef.SKUCLS_P0_03);
        delButton.addClickHandler(new DeleteAction2(table));
...
//		txt_mofify.setColSpan(1);
	...
	public Canvas createCanvas(String id,TabSet tabSet) {
		BasSkuClassView2 view = new BasSkuClassView2();
		view.setFUNCID(id);

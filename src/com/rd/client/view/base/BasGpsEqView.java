...
public class BasGpsEqView extends SGForm implements PanelFactory {
	...
	public Canvas getViewPanel() {
		...
		gpsTable.addSelectionChangedHandler(new SelectionChangedHandler() {
			...
			public void onSelectionChanged(SelectionEvent event) {
				if(gpsTable.getSelectedRecord()==null) return;
				...
				if(bottomTabSet.getSelectedTabNumber()==0){
		            ...
		            areaTable.PVALUE = record.getAttribute("ID");
	...
	private Canvas createdownInfo() {
		...
		TextAreaItem AB_NOTES = new TextAreaItem("NOTES", "异常描述");
...
//		});
		...
		panel.setItems(CLAIM_TIME,ABNORMAL_FLAG,ABNORMAL_REASON,DUTY_TO,AB_NOTES);

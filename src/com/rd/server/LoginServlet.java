...
//    private String main = "/test/mainform.html";
      private String login = "location.href ='/pfs/login.jsp'";
      private String main = "/mainform.html?gwt.codesvr=127.0.0.1:9997";
	...
	public void doGet(HttpServletRequest request,final HttpServletResponse response)
        ...
        String system = ObjUtil.ifNull(request.getParameter("system"), "").toString();
...
//		}
	        ...
	        if(object != null && object.size() > 0) {
	        	...
	        	if("Y".equalsIgnoreCase(flag) || "TRUE".equalsIgnoreCase(flag)){
	            	...
	            	if(!pwd.equals(user.getPASSWORD())) {
	            		...
	            		response.addCookie(new Cookie("LOGIN_SYSTEM",system));
    ...
    protected void getProperties() {
    	try {
		    ...
		    //获取输入流
		    FileInputStream in = new FileInputStream(path + "\\cfg.properties");
		    Properties p=new Properties();
		    //类的装载
		    p.load(in);
		    //拿到配置文件中userName参数
		    main = p.getProperty("loginServerContextRoot");
    	}
    	catch(Exception e) {
    		e.printStackTrace();
    	}

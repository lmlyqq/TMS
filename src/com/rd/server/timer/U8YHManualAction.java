...
public class U8YHManualAction{
	...
	private String orderHeader(String custom_odr_no) throws Exception{
    	...
    	sql.append(",COWHCODE,CIWHCODE,DMDATE,CMAKER,CADDCODE,CDELIVERYCODE,FH01_FHXX,CDEFINE6,CACCID,CSAPSOCODE,CCUSCITY from DispatchList_bak");
	...
	private void orderItem(String fid)  throws Exception{
    	...
    	itemSQL.append("select iID,ID,CVOUCHTYPE,DLID,AUTOID,CINVCODE,CWHCODE,IQUANTITY,CBATCH,CFREE2,CSBVCODE,DBVDATE from DispatchLists_bak");

 ...
 *
 */
public class NewSFOrderItemAction implements ClickHandler,com.smartgwt.client.widgets.events.ClickHandler{
	...
	public NewSFOrderItemAction(SGTable p_table,SFOrderView view) {
		table = p_table;
		this.view = view;
	}

 ...
 *
 */
public class ShpmDS3 extends DataSource{
	private static ShpmDS3 instance = null;

	public static ShpmDS3 getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ShpmDS3(id, tableName);
		}
		return instance;
	}

	public static ShpmDS3 getInstance(String id) {
		if (instance == null) {
			instance = new ShpmDS3(id, id);
		}
		return instance;
	}

	public ShpmDS3(String id, String tableName) {

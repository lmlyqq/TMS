 ...
 *
 */
public class SaveComplaintAction implements ClickHandler {
	...
	private SGForm view;
	public SaveComplaintAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, Map<String, String > p_corr) {
		table = p_table;
		form = p_form;  
		map = p_map;
		id_name = p_corr;
	}
	public SaveComplaintAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map) {
		table = p_table;
		form = p_form;  
		map = p_map;
	}
	
	public SaveComplaintAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, SGForm view) {
		table = p_table;
		form = p_form;  
		map = p_map;
//		id_name = p_corr;
	...
	public void onClick(ClickEvent event) {
		...
		if(record != null) {
			...
			if(record.get("STATUS").equals("B2F67CD5A0E1491E8824DDA86E9BED46")){
				SC.say("状态不能选为已完结");
				return;
			}

 ...
 *
 */
public class StandTrriffHeaderDS extends DataSource{
	private static StandTrriffHeaderDS instance = null;

	public static StandTrriffHeaderDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new StandTrriffHeaderDS(id, tableName);
		}
		return instance;
	}

	public static StandTrriffHeaderDS getInstance(String id) {
		if (instance == null) {
			instance = new StandTrriffHeaderDS(id, id);
		}
		return instance;
	}

	public StandTrriffHeaderDS(String id, String tableName) {

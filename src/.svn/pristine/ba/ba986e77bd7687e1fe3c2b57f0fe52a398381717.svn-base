 ...
 *
 */
public class UnShpmDS extends DataSource{
	private static UnShpmDS instance = null;

	public static UnShpmDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new UnShpmDS(id, tableName);
		}
		return instance;
	}

	public static UnShpmDS getInstance(String id) {
		if (instance == null) {
			instance = new UnShpmDS(id, id);
		}
		return instance;
	}

	public UnShpmDS(String id, String tableName) {

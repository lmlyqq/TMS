 ...
 *
 */
public class BillLoadFee2DS extends DataSource{
	private static BillLoadFee2DS instance = null;

	public static BillLoadFee2DS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillLoadFee2DS(id, tableName);
		}
		return instance;
	}

	public static BillLoadFee2DS getInstance(String id) {
		if (instance == null) {
			instance = new BillLoadFee2DS(id, id);
		}
		return instance;
	}

	public BillLoadFee2DS(String id, String tableName) {

 ...
 *
 */
public class ShpmCancelUnionAction implements ClickHandler {

	private SGForm view;
	private SGTable unshpmTable;
	private DispatchView dv;
	private TmsShipmentView tv;
	public ShpmCancelUnionAction(SGForm form, SGTable p_unshpmTable) {
		this.view = form;
	...
	public void doCancel() {
		...
		Util.async.execProcedure(json, "SP_SHPM_CANCEL_UNION(?,?,?)", new AsyncCallback<String>() {
			@Override

 ...
 *
 */
public class ShpmDS5 extends DataSource{
	private static ShpmDS5 instance = null;

	public static ShpmDS5 getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ShpmDS5(id, tableName);
		}
		return instance;
	}

	public static ShpmDS5 getInstance(String id) {
		if (instance == null) {
			instance = new ShpmDS5(id, id);
		}
		return instance;
	}

	public ShpmDS5(String id, String tableName) {

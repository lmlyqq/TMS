...
public class DeleteDetailAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{
	...
	public DeleteDetailAction(SGTable table, SGForm view,ValuesManager form,int initBtn) {
		this.table = table;
		this.view=view;
		this.form = form;

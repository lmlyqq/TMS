...
public class VehicleWin extends Window {
	...
	public VehicleWin(ListGrid table,int row,String top,String left,String plate_no,String suplr_id){
		this.table = table;
		this.row = row;
		this.top = top;
		this.left = left;
	...
	public Window getViewPanel() {
		...
		Util.initComboValue(VEHICLE_TYP_ID, "BAS_VEHICLE_TYPE", "ID", "VEHICLE_TYPE", " WHERE  ENABLE_FLAG = 'Y'", " ORDER BY SHOW_SEQ ASC");
...
//		final SGText FULL_INDEX = new SGText("FULL_INDEX","模糊查询",true);
//		FULL_INDEX.setValue(plate_no);

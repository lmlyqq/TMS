 ...
 *
 */
public class ShpmDS2 extends DataSource{
	private static ShpmDS2 instance = null;

	public static ShpmDS2 getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ShpmDS2(id, tableName);
		}
		return instance;
	}

	public ShpmDS2(String id, String tableName) {

 ...
 */
public class PayNewAction implements ClickHandler,com.smartgwt.client.widgets.menu.events.ClickHandler{
	...
	public PayNewAction (ListGrid table,boolean isAud,BmsSuplrFeeView view){
		this.table = table;
		this.isAud = isAud;
		this.view = view;
	}

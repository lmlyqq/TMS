...
public class ReclaimDS extends DataSource{
	
	private static ReclaimDS instance = null;

	public static ReclaimDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ReclaimDS(id, tableName);
		}
		return instance;
	}

	public static ReclaimDS getInstance(String id) {
		if (instance == null) {
			instance = new ReclaimDS(id, id);
		}
		return instance;
	}

	public ReclaimDS(String id, String tableName) {

 ...
 *
 */
public class ShpmDetailDS extends DataSource{
	private static ShpmDetailDS instance = null;

	public static ShpmDetailDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ShpmDetailDS(id, tableName);
		}
		return instance;
	}

	public static ShpmDetailDS getInstance(String id) {
		if (instance == null) {
			instance = new ShpmDetailDS(id, id);
		}
		return instance;
	}

	public ShpmDetailDS(String id, String tableName) {

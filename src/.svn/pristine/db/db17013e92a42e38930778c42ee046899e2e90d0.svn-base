 ...
 *
 */
public class TariffHeaderDS extends DataSource{
	private static TariffHeaderDS instance = null;

	public static TariffHeaderDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new TariffHeaderDS(id, tableName);
		}
		return instance;
	}

	public static TariffHeaderDS getInstance(String id) {
		if (instance == null) {
			instance = new TariffHeaderDS(id, id);
		}
		return instance;
	}

	public TariffHeaderDS(String id, String tableName) {

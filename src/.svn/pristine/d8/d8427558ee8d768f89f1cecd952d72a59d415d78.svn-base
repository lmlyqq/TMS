 ...
 *
 */
public class NewTariffRuleAction extends NewFormAction{
	private RateManagerView view;
	private PoleManagerView poleView;
	private boolean isTff = true;
	public NewTariffRuleAction(ValuesManager pForm, Map<String, String> map,RateManagerView view) {
		super(pForm, map);
		this.view = view;
	}
	
	public NewTariffRuleAction(ValuesManager pForm, Map<String, String> map,PoleManagerView view,boolean isTff) {
		super(pForm, map);
		this.poleView = view;
		this.isTff = isTff;
	}
	public NewTariffRuleAction(DynamicForm pForm, Map<String, String> map,PoleManagerView view,boolean isTff) {
		super(pForm, map);
		this.poleView = view;
		this.isTff = isTff;
	}

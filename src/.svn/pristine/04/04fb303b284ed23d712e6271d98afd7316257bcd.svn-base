 ...
 *
 */
public class RecAdjExportAction implements ClickHandler,com.smartgwt.client.widgets.menu.events.ClickHandler{
	
	private ListGrid table;
	
	public RecAdjExportAction(ListGrid table){
		this.table = table;
	}
	
	public RecAdjExportAction(ListGrid table, String orderby) {
		this.table = table;
	}
	...
	public void onClick(ClickEvent event) {
		...
		sql.append(" ,t.PARENT_CUSTOMER_NAME ");
		String where = ObjUtil.ifNull(JSOHelper.getAttribute(table.getJsObj(), "WHERE"),"");		
		sql.append(where.replace("V_REC_ADJUST", "V_REC_ADJUST t"));

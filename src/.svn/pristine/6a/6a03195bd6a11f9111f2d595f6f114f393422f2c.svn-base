...
public class DeleteSuplrRuleAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{

	private ValuesManager form;
	private ListGrid table;
	private ListGridRecord[] records;
	public DeleteSuplrRuleAction(ListGrid p_table, ValuesManager p_form) {
		table = p_table;
		form = p_form;
	}

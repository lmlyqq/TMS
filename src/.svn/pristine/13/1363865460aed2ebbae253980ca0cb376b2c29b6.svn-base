...
public class DeleteFormAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler {

	private DynamicForm form;
	private ListGrid table;
	private ListGridRecord[] records;
	public DeleteFormAction(ListGrid p_table, DynamicForm p_form) {
		table = p_table;
		form = p_form;
	}

 ...
 *
 */
public class ShpmGroupAction implements ClickHandler {

	private SGForm view;
	private SGTable unshpmTable;
	private DispatchView dv;
	private TmsShipmentView tv;
	public ShpmGroupAction(SGForm form, SGTable p_unshpmTable) {
		this.view = form;
	...
	public void doCancel() {
		...
		Util.async.execProcedure(json, "SP_SHPM_GROUP(?,?,?)", new AsyncCallback<String>() {
			@Override

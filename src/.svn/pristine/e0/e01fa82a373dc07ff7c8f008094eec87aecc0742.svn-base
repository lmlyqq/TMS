 ...
 *
 */
public class BmsCustomerDS extends DataSource {
	
	private static BmsCustomerDS instance = null;

    public static BmsCustomerDS getInstance(String id) {
        if (instance == null) {
            instance = new BmsCustomerDS(id, id);
        }
        return instance;
    }
    
    public static BmsCustomerDS getInstance(String id, String tableName) {
        if (instance == null) {
            instance = new BmsCustomerDS(id, tableName);
        }
        return instance;
    }
    public BmsCustomerDS(String id, String tableName) {

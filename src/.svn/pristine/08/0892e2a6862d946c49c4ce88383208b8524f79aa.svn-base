...
public class VehicleLoadDS extends DataSource{
	
	private static VehicleLoadDS instance = null;

	public static VehicleLoadDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new VehicleLoadDS(id, tableName);
		}
		return instance;
	}

	public static VehicleLoadDS getInstance(String id) {
		if (instance == null) {
			instance = new VehicleLoadDS(id, id);
		}
		return instance;
	}

	public VehicleLoadDS(String id, String tableName) {

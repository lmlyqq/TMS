...
public class saveTaffRulStandAction implements ClickHandler{
	...
	private RateManagerRecView rview;
	
	private PoleManagerView pview;
	
	public saveTaffRulStandAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, StandardRateView view) {
		this.view = view;
		table = p_table;
		form = p_form;  
		map = p_map;
	...
	public saveTaffRulStandAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, RateManagerRecView view) {
		this.rview = view;
		table = p_table;
		form = p_form;  
		map = p_map;
	...
	public saveTaffRulStandAction(ListGrid p_table, ValuesManager p_form, HashMap<String, String> p_map, PoleManagerView view) {
		this.pview = view;
		table = p_table;
		form = p_form;  
		map = p_map;
			...
			public void onSuccess(String result) {
				if(result.substring(0,2).equals(StaticRef.SUCCESS_CODE)) {
					...
					if(view != null){
						...
						rview.initSaveRuleBtn();
					}
					else if(pview != null){
						pview.initSaveRuleBtn();
					}
					Criteria cri=new Criteria();
					cri.addCriteria("OP_FLAG",StaticRef.MOD_FLAG);
					cri.addCriteria("TFF_ID",view.selectRecord.getAttributeAsString("ID"));
					if(view.crit !=null){

...
import com.rd.client.view.settlement.RecDamageView;
 ...
 */
public class SaveDmgInvoiceAction  implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{
	...
	private RecDamageView view;
	private Map<String,String> comb_val;
	
	public SaveDmgInvoiceAction(ListGrid p_table, DynamicForm p_form, HashMap<String, String> p_map, Map<String, String > p_corr) {
		table = p_table;
		form = p_form;
		map = p_map;        
		id_name = p_corr;   
	...
	public SaveDmgInvoiceAction(ListGrid t_table,ListGrid p_table, DynamicForm p_form, HashMap<String, String> p_map, RecDamageView view) {
		Ttable=t_table;
		table = p_table;
		form = p_form;
		map = p_map;        //系统校验的MAP
	...
	private void click(){
		...
		String T_ACT_AMOUNT=ObjUtil.ifObjNull(Ttable.getSelectedRecord().getAttribute("TOTAL_AMOUNT"),0).toString();

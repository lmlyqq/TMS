...
public class ShpmDS4 extends DataSource{
	private static ShpmDS4 instance = null;

	public static ShpmDS4 getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new ShpmDS4(id, tableName);
		}
		return instance;
	}

	public static ShpmDS4 getInstance(String id) {
		if (instance == null) {
			instance = new ShpmDS4(id, id);
		}
		return instance;
	}

	public ShpmDS4(String id, String tableName) {

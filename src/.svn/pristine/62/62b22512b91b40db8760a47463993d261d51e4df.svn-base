 ...
 *
 */
public class CancelJourneySplitAction implements ClickHandler {

	private SGForm view;
	private SGTable unshpmTable;
	private DispatchView dv;
	private TmsShipmentView tv;
	public CancelJourneySplitAction(SGForm form, SGTable p_unshpmTable) {
		this.view = form;
	...
	public void doCancel() {
		...
		Util.async.execProcedure(json, "SP_SHPM_CANCEL_JRNY_SPLIT(?,?,?,?)", new AsyncCallback<String>() {
			@Override

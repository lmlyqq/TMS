 ...
 *
 */
public class BillPayDS extends DataSource{

	private static BillPayDS instance = null;

	public static BillPayDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillPayDS(id, tableName);
		}
		return instance;
	}

	public static BillPayDS getInstance(String id) {
		if (instance == null) {
			instance = new BillPayDS(id, id);
		}
		return instance;
	}

	public BillPayDS(String id, String tableName) {

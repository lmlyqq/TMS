 ...
 *
 */
public class BillPayDetailDS extends DataSource{

	private static BillPayDetailDS instance = null;

	public static BillPayDetailDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillPayDetailDS(id, tableName);
		}
		return instance;
	}

	public static BillPayDetailDS getInstance(String id) {
		if (instance == null) {
			instance = new BillPayDetailDS(id, id);
		}
		return instance;
	}

	public BillPayDetailDS(String id, String tableName) {

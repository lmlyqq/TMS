 ...
 * 
 */
public class UnShpmPrintNewAction implements com.smartgwt.client.widgets.menu.events.ClickHandler{

	//调度单信息二级表
	@SuppressWarnings("unused")
	private VehicleDispatchView view;
	private SGTable unshpmTable;
	public UnShpmPrintNewAction(VehicleDispatchView view, SGTable p_table){
		this.view = view;

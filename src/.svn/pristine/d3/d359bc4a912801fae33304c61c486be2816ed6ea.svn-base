 ...
 *
 */
public class NewAction implements ClickHandler,com.smartgwt.client.widgets.menu.events.ClickHandler{
	...
	public NewAction(SGTable p_table) {
		table = p_table;
	}
	public NewAction(SGTable p_table,Map<String, String> initMap) {
		table = p_table;
		this.initMap = initMap;
	}
	public NewAction(SGTable p_table,Map<String, String> initMap,SGForm view,int initBtn) {
		table = p_table;
		this.initMap = initMap;
		this.view = view;
	...
	public NewAction(SGTable p_table,Map<String, String> initMap,SGForm view) {
		table = p_table;
		this.initMap = initMap;
		this.view = view;
	}
	
	public NewAction(SGTable p_table, SGTable p_maintable) {
		table = p_table;
		main_table = p_maintable;
	}
	
	public NewAction(SGTable p_table, SGTable p_maintable, Map<String, String> initMap) {
		table = p_table;
		main_table = p_maintable;
		this.initMap = initMap;
	}
	public NewAction(SGTable p_table, SGTable p_maintable, Map<String, String> initMap,SGForm view) {
		table = p_table;
		main_table = p_maintable;
		this.initMap = initMap;
		this.view = view;

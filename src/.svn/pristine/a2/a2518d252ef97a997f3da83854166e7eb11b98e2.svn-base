 ...
 *
 */
public class BillSettPayDS extends DataSource{

	private static BillSettPayDS instance = null;

	public static BillSettPayDS getInstance(String id, String tableName) {
		if (instance == null) {
			instance = new BillSettPayDS(id, tableName);
		}
		return instance;
	}

	public static BillSettPayDS getInstance(String id) {
		if (instance == null) {
			instance = new BillSettPayDS(id, id);
		}
		return instance;
	}

	public BillSettPayDS(String id, String tableName) {

 ...
 *
 */
public class NewOilFormAction implements ClickHandler,com.smartgwt.client.widgets.form.fields.events.ClickHandler{

	private DynamicForm form;
	private Map<String, String> initMap;
	private SGForm view;
	private ValuesManager vm;
	public NewOilFormAction(DynamicForm p_form, Map<String, String> map) {
		form = p_form;
		initMap = map;
	}
	
	public NewOilFormAction(DynamicForm p_form, Map<String, String> map,SGForm view) {
		form = p_form;
		initMap = map;
		this.view = view;
	}
	
	public NewOilFormAction(ValuesManager vm,Map<String, String> map){
		this.vm = vm;
		this.initMap = map;
	}
